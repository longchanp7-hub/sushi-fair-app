...
const ICON={
  ...
  totomaru:'<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M9 33c9-13 22-18 35-10l11-7-2 15 2 15-11-7c-13 8-26 3-35-6z" fill="currentColor"/><circle cx="24" cy="29" r="3" fill="#fff"/></svg>',
