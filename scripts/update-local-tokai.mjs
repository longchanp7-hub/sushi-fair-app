...
async function totomaru(){
  ...
  try{
    ...
    return {chain:'totomaru',group:'local_tokai',storeName:'選択地域',fairName:primary.fairName,startDate:primary.startDate,endDate:primary.endDate,items, campaigns:uniqueCampaigns,sourceUrl:menu,storeUrl:'https://www.comline.co.jp/shoplist/',imageUrl:isGenericOg(og($,home))?null:og($,home),status:items.length?'ok':'warning',message:items.length?null:'公式の季節メニューは確認できました。個別商品・価格は公式メニューで確認してください。',dataScope:'local_official_menu',officialActionLabel:'店舗・順番待ちを公式で確認',officialActionUrl:'https://www.comline.co.jp/shoplist/',regionalModel:{strategyKey:'exactLocalStore',label:'選択市区町村の実店舗',priceVariesByLocation:true},priceNote:'店舗・入荷状況により取扱いが異なる場合があります。'};
  }catch{return {chain:'totomaru',group:'local_tokai',storeName:'選択地域',fairName:'季節のおすすめ',startDate:null,endDate:null,items:[],campaigns:[],sourceUrl:menu,storeUrl:'https://www.comline.co.jp/shoplist/',imageUrl:null,status:'warning',message:'公式サイトの自動取得に失敗したため、推測データは表示していません。',dataScope:'official_link_only',officialActionLabel:'店舗・順番待ちを公式で確認',officialActionUrl:'https://www.comline.co.jp/shoplist/',regionalModel:{strategyKey:'exactLocalStore',label:'選択市区町村の実店舗',priceVariesByLocation:true}};}
}
async function musashimaru(){const menu='https://www.634-jp.com/musashimaru-menu.html';return {chain:'musashimaru',group:'local_tokai',storeName:'選択地域',fairName:'公式メニュー・おすすめ',startDate:null,endDate:null,items:[],campaigns:[],sourceUrl:menu,storeUrl:'https://www.634-jp.com/musashimaru-shop.html',imageUrl:null,status:'warning',message:'期間限定商品の安定したテキスト取得元が確認できないため、個別商品は推測せず公式メニューへ案内します。',dataScope:'official_link_only',officialActionLabel:'店舗情報を公式で確認',officialActionUrl:'https://www.634-jp.com/musashimaru-shop.html',regionalModel:{strategyKey:'exactLocalStore',label:'選択市区町村の実店舗',priceVariesByLocation:false},priceNote:'公式メニューで各皿価格と最新のおすすめをご確認ください。'};}
